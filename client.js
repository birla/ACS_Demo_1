...
const {
  ...
  let hangUpCallButtonSecond = document.getElementById(
    "hangup-call-button-second"
  );
  ...
  let subscribeToCall;
  let subscribeToRemoteParticipant;
  let subscribeToRemoteVideoStream;
    ...
    try {
      ...
      call.on("stateChanged", async () => {
        ...
        if (call.state === "Connected") {
          ...
          hangUpCallButtonSecond.disabled = false;
          ...
          hangUpCallButtonSecond.disabled = true;
  ...
  hangUpCallButtonSecond.addEventListener("click", async () => {
    // end the current call
    await call.hangUp();
  });
